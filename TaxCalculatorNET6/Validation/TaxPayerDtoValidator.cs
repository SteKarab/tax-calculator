...
namespace TaxCalculatorNET6.Validation;
...
public class TaxPayerDtoValidator: AbstractValidator<TaxPayerDto>
{
    ...
    public TaxPayerDtoValidator()
    {
        ...
        RuleFor(taxPayer => taxPayer.CharitySpent).NotNull().Must(BeHigherOrEqualToZero).WithMessage("CharitySpent must be higher than or equal to 0!");;
    }
